...
<head>
	...
	<title>Burger And Sandwiches Menu</title>
	...
	<div id="overlayIndividual">
		...
		<div class="overlayImgContainer">
			<div class="imgcontainer">
				<figure>
					<img src="../img/new images/1152017/Burgers and sandwiches/Chicken SandWiches.jpg" >
				</figure>
		...
		<div class="overlayImgContainer">
			<div class="imgcontainer">
				<figure>
					<img src="../img/menus/Burgers and Sandwiches/german frank hotdog.jpg" alt="ImageTwo">
				</figure>
				 <div class="individualDescription">
					 <h4>German Franks Hotdog</h4>
					 <h5>&#8369; 80.00</h5>
				 </div>
			</div>
		</div>
		<div class="overlayImgContainer">
			<div class="imgcontainer">
				<figure>
					<img src="../img/menus/Burgers and Sandwiches/angus beef hotdog.jpg" alt="ImageTwo">
				</figure>
				 <div class="individualDescription">
					 <h4>Angus Beef Hotdog</h4>
					 <h5>&#8369; 80.00</h5>
				 </div>
			</div>
		</div>
		<div class="overlayImgContainer">
			<div class="imgcontainer">
				<figure>
					<img src="../img/menus/Burgers and Sandwiches/cheese burger.jpg" alt="ImageTwo">
				</figure>
				 <div class="individualDescription">
					 <h4>Cheese Burger</h4>
					 <h5>&#8369; 100.00</h5>
		...
		<div class="overlayImgContainer">
			<div class="imgcontainer">
				<figure>
					<img src="../img/menus/Burgers and Sandwiches/bacon_Wrapped_cheese_buger.jpg" alt="ImageTwo">
				</figure>
				 <div class="individualDescription">
					 <h4>Bacon Wrapped Cheese Burger</h4>
					 <h5>&#8369; 120.00</h5>
				 </div>
			</div>
		</div>
		<div class="overlayImgContainer">
			<div class="imgcontainer">
				<figure>
					<img src="../img/menus/Burgers and Sandwiches/midnight cheesy burger.jpg" alt="ImageTwo">
				</figure>
				 <div class="individualDescription">
					 <h4>Midnight Cheesy Burger </h4>
					 <h5>&#8369; 120.00</h5>
				 </div>
			</div>
		</div>
		<div class="overlayImgContainer">
			<div class="imgcontainer">
				<figure>
					<img src="../img/menus/Burgers and Sandwiches/mid night-cheesy burger with bacon.jpg" alt="ImageTwo">
				</figure>
				 <div class="individualDescription">
					 <h4>Midnight Cheesy Burger w/ Bacon</h4>
					 <h5>&#8369; 140.00</h5>
				 </div>
			</div>
		</div>
				...
				<div class="row">
					...
					<div class="col">
						<figure>
							<img src="../img/menus/Burgers and Sandwiches/ham and egg sandwich.jpg" alt="">	
							<figcaption class="dishcattitle">
							    <h4 class="dishname">Ham &amp; Egg Sandwich</h4>
					            <h5 class="dishprice">&#8369; 70.00</h5>		
							</figcaption>
						</figure>	
					</div>
					<div class="col">
						<figure>
							<img src="../img/menus/Burgers and Sandwiches/german frank hotdog.jpg" alt="ImageTwo">	
							<figcaption class="dishcattitle">
								<h4 class="dishname">German Franks Hotdog</h4>
				...
				<div class="row">
					<div class="col">
						<figure>
							<img src="../img/menus/Burgers and Sandwiches/bacon_Wrapped_cheese_buger.jpg" alt="ImageTwo">	
							<figcaption class="dishcattitle">
                                <h4 class="dishname" style="font-size:.9em;">Bacon Wrapped Cheese Burger</h4>
					...
					<div class="col">
						<figure>
							<img src="../img/menus/Burgers and Sandwiches/midnight cheesy burger.jpg" alt="ImageTwo">	
							<figcaption class="dishcattitle">
                                <h4 class="dishname" style="font-size:.8em;">Midnight Cheesy Burger </h4>
                                <h5 class="dishprice">&#8369; 120.00</h5>
							</figcaption>
						</figure>
                    </div>
                    <div class="col">
						<figure>
							<img src="../img/menus/Burgers and Sandwiches/mid night-cheesy burger with bacon.jpg" alt="ImageTwo">	
							<figcaption class="dishcattitle">
							    <h4 class="dishname" style="font-size:.8em;">Midnight Cheesy Burger w/ Bacon</h4>
